                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <select name="category_id" id="category_id" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" required>
                                ...
                                <option value="1" <?= $product->category_id == 1 ? 'selected' : '' ?>>Merchandise</option>
                                <option value="2" <?= $product->category_id == 2 ? 'selected' : '' ?>>F&B</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="is_active" id="is_active" class="w-4 h-4 text-blue-600 bg-gray-800 border-gray-700 rounded focus:ring-blue-500" <?= $product->is_active ? 'checked' : ''; ?>>
