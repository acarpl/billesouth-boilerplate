                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="min_purchase" id="min_purchase" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Enter minimum purchase amount" value="0" min="0">
                            </div>

                            <div>
                                <label for="max_discount" class="block text-sm font-medium text-gray-300 mb-2">Maximum Discount (Rp)</label>
                                <input type="number" name="max_discount" id="max_discount" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Enter maximum discount amount" value="0" min="0">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="usage_limit" id="usage_limit" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Enter usage limit (0 for unlimited)" value="0" min="0">
                        </div>
