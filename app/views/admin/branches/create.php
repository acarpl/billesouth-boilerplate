                ...
                <form action="<?= BASEURL; ?>/admin/branches/store" method="POST">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="address" id="address" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Enter branch address" required>
                        </div>

                        <div>
                            <label for="phone_wa" class="block text-sm font-medium text-gray-300 mb-2">Phone/WhatsApp</label>
                            <input type="tel" name="phone_wa" id="phone_wa" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Enter phone/WhatsApp number" required>
                        </div>

                        <div>
                            <label for="maps_link" class="block text-sm font-medium text-gray-300 mb-2">Maps Link</label>
                            <input type="url" name="maps_link" id="maps_link" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Enter Google Maps link">
                        </div>
                    </div>
