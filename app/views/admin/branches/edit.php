...
<div class="flex">
    ...
    <main class="flex-1 p-8 bg-gray-950 min-h-screen">
        <div class="max-w-2xl mx-auto">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-white">Edit Cabang</h1>
                <p class="text-gray-400">Perbarui detail cabang di bawah ini</p>
            </div>
                ...
                <form action="<?= BASEURL; ?>/admin/branches/update/<?= $branch->id; ?>" method="POST">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="maps_link" id="maps_link" class="w-full bg-gray-800 border border-gray-700 text-white rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5" value="<?= htmlspecialchars($branch->maps_link ?? ''); ?>" placeholder="Masukkan link Google Maps">
                        </div>
                    </div>
